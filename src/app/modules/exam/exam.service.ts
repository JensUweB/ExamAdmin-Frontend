...
const examsQuery = gql`query getPlannedExams{getPlannedExams{
    _id, title, description, examDate, regEndDate, isPublic, examPlace , club{name}, participants{_id, firstName, lastName, martialArts{_id{_id}, rankName}}, 
    martialArt{_id, name, styleName}, examiner{_id, firstName, lastName, clubs{club{_id}}}
  }}`;

const clubsQuery = gql`query getClubById($id: String!){getClubById(id: $id){_id, name}}`;
